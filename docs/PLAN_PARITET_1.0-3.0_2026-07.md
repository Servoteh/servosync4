...
| 3 | **Reversi + Lokacije zajedno** (~49 fn) | 🟨 PRIPREMA URAĐENA — grana `feat/sy15-seoba-reversi`: 14 Prisma modela, prenosna skripta 195/195, prekidač `REVERSI_IZVOR`; ostaje prepisivanje `rev_issue_reversal`/`rev_confirm_return` (~5–8 dana) + loc deo |
