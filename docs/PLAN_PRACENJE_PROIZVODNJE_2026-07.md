...
| **F2 — preklop** | `/pracenje-proizvodnje` na novi izvor; paralelna verifikacija (staro sy15 čitanje vs novo, na živim predmetima); gašenje `Sy15Service` iz pracenje modula. | F1 |
