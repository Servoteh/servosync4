...
| **F4 — kooperacija** | ⏸ **ODLOŽENO ZA 4.0** (Nenad, 19.07.2026) — gradi se uz 4.0 talas. Analiza + model spremni: [ANALIZA_KOOPERACIJA_F4.md](ANALIZA_KOOPERACIJA_F4.md) (K1–K3 presuđene: tri nivoa vezivanja, auto-razlaganje sklopa, vrsta na zaglavlju+RJ grupi; K4–K8 čekaju 4.0). F1 koop tabele ostaju neaktivne. | 4.0 |
