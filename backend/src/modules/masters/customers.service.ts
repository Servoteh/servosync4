...
export function customerBigBitOriginMessage(customer: CustomerOrigin): string {
  ...
  return (
    ...
    `${sifra} — izmena ovde stiže automatski noćnim uvozom i vidljiva je sutra ` +
    "ujutru; ako ne može da čeka, obratite se administratoru."
  );
}
...
export function bigBitTwinException(
  ...
  return new ConflictException({
    ...
    message:
      ...
      "sa istim PIB-om, unesite ga u BigBit-u — ovde stiže automatski noćnim uvozom " +
      "i vidljiv je sutra ujutru.",
    taxId,
  });
}
