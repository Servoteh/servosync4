...
export class SyncService {
  ...
  constructor(
    ...
    // Ovde su ranije bili registrovani handover-derivation syncer (tRN ->
    // drawing_handovers + remap) i §5.3 privremeni chain-item importeri
    // (tabele bez generisanog mapiranja) — svi OBRISANI zajedno sa podelom
    // sync mape (chain entiteti izbačeni iz sync-map.generated.ts). Ostaje
    // samo trajni BigBit sync (customers + generički map-driven synceri).
    // Vidi QBIGTEHN_CHAIN_ENTITIES u table-ownership.ts.
  }
