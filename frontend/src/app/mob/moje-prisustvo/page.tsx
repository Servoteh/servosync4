...
/**
 * Mobilno „Moje prisustvo" (/mob/moje-prisustvo) — G6 self-service. Zaposleni vidi
 * svoje dnevne prolaze i podnosi korekciju (ulaz/izlaz + razlog) za svoj dan.
 * Guard = profile.self; RPC (own ∨ manager) presuđuje. Van AppShell-a (full-screen
 * mobilni panel).
 *
 * ⚠️ Ime rute je `moje-prisustvo`, NE `prisustvo`: `/mob/prisustvo` je DRUGI ekran
 * (pregled prisustva uživo za kadrovsku, zahtev 019/26). Ruta je namerno van `/m/*`
 * (worker proxy sve `/m/*` na javnom domenu šalje na 1.0) — PLAN_MOB_3.0 Faza 0.
 */
export default function MobMojePrisustvoPage() {
