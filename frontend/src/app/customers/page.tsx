        ...
        */}
        <div className="rounded-panel border border-line bg-surface-2 px-4 py-3 text-sm text-ink-secondary">
          ...
          <p className="mt-1">
            ...
            komitent unet danas vidljiv je sutra ujutru, tek tada može da se bira na
            dokumentima. Dugme „Pokreni sync“ na Sinhronizacijama NE donosi nove komitente.
            Izmena podataka (adresa, PIB, kontakt) radi se isto u BigBit-u — ovde se ne menja
            ništa.
          </p>
        </div>
