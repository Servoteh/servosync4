...
// Stara 1.0 ruta `/maintenance/assets/machines` → 3.0 `/odrzavanje?tab=masine` (cutover 1.0, 05.08.2026).
...
export default function LegacyMaintenanceAssetsMachinesRedirectPage() {
