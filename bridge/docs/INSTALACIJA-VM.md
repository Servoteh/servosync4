# Zapis stanja — bridge VM 192.168.64.24 (2026-07-05) · ⚠️ ISTORIJAT

> **OVO VIŠE NIJE PRODUKCIJA.** Od 20.07.2026. i bridge i gateway rade na **ubuntusrv**
> kao `systemd --user` jedinice; servisi na ovoj Windows VM su `Stopped / Disabled` i
> **ne smeju se paliti** (bio bi drugi PCOM klijent na Unitronics-u).
> Aktuelno stanje: [../CLAUDE.md](../CLAUDE.md) i [../../scada/CLAUDE.md](../../scada/CLAUDE.md).
> Ovaj fajl se drži kao zapis kako je bilo postavljeno (winsw, node-windows, putanje).
