...
/** Segmentovani tab prekidač (DESIGN_SYSTEM §4/§8: ←/→ menjaju tab). Wrap za mnogo tabova. */
export function Tabs<K extends string>({
  ...
  return (
    <div
      ...
      onKeyDown={onKeyDown}
      className="flex flex-wrap gap-1 rounded-panel border border-line bg-surface p-1"
    >
      {tabs.map((t) => {
