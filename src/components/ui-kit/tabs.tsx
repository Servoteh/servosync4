...
/**
 * Segmentovani tab prekidač (DESIGN_SYSTEM.md §4/§8: ←/→ menjaju tab, aktivan =
 * akcentna pozadina). Deljena verzija (tech-processes/reversi obrazac) za PB/profil/
 * Podešavanja — 3.0 TALAS D.
 */
